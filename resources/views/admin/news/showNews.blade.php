...
<section>
    <div class="flex-container">
        ...
        <button class="btn btn-info" type="button" onclick="location.href='{{ route('news.edit', $news->id) }}'">Update News</button>
       
        <button class="btn btn-danger" type="button" onclick="confirmDelete()">Delete News</button>

        <form id="delete-product-form" action="{{ route('news.delete', $news->id) }}" method="POST" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
